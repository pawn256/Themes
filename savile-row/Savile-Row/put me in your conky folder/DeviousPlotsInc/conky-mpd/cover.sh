...
CACHE="$HOME/.covers"
# API Key for Last.fm
APIKEY="0000000000000000000000000"    <<<<<  replace with your Last.fm key
...
cp $HOME/.conky/DeviousPlotsInc/conky-mpd/nocover.png /tmp/conkyCover.png
echo "NoCover" >> $LOG
...
convert /tmp/cover.png $HOME/.conky/DeviousPlotsInc/conky-mpd/case.png -composite /tmp/cover.png >> $LOG
